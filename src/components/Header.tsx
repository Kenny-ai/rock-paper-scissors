...
const Header = () => {
  const styles = {
    ...
    score:
      "score bg-sky-100 flex items-center justify-center px-6 rounded-lg lg:px-12",
  };
      ...
      <div className={styles.header}>
        ...
        <div className={styles.score}>
          <div className="score flex items-center flex-col">
            <p className="text-blue-500 uppercase">score</p>
            <p className="text-gray-500 text-4xl lg:text-6xl">0</p>
          </div>
        </div>
      </div>
    </div>
